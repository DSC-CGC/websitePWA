...
<script>
import SpeakerDetails from '@/assets/data/challenges.json'
import SpeakerDialog from '@/components/common/ChallengesDialog.vue'
export default {
    components:{
        SpeakerDialog
    },
    ...
    methods:{
        getImgUrl(pic) {
            if(pic.length>0){
                return ('https://magenta.tensorflow.org/assets/magenta-logo-bottom-text.png')
            }else{
                return ('https://magenta.tensorflow.org/assets/magenta-logo-bottom-text.png')
            }
        },
